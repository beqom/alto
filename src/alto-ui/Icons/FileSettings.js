...
const FileSettingsOutline = props => (
  <g>
    <path
    ...
    />
    <path
      d="M24.12,20.35a4,4,0,1,0,4.08,4A4.06,4.06,0,0,0,24.12,20.35Zm0,6.46a2.43,2.43,0,1,1,2.48-2.43A2.46,2.46,0,0,1,24.12,26.82Z"
      {...props}
    />
    <path
      d="M14.49,31H6V5H26v7.89a3.2,3.2,0,0,1,2,1.72V5a2,2,0,0,0-2-2H6A2,2,0,0,0,4,5V31a2,2,0,0,0,2,2H16.23l-1.1-1.08A3.11,3.11,0,0,1,14.49,31Z"
      {...props}
    />
  </g>
);

const FileSettingsSolid = props => (
  <g>
    <path
      {...props}
...
const FileSettings = props => (
  <Icon {...props}>
    {props.outline
      ? ownProps => <FileSettingsOutline {...ownProps} />
      : ownProps => <FileSettingsSolid {...ownProps} />}
  </Icon>
);
