...
const PopulationsOutline = props => (
  <g>
    <path
      {...props}
...
const PopulationsSolid = props => (
  <g>
    ...
    />
    <circle {...props} cx="17.87" cy="13.45" r="4.47" />
    <path
      {...props}
...
const Populations = props => (
  <Icon {...props}>
    {props.outline
      ? ownProps => <PopulationsOutline {...ownProps} />
      : ownProps => <PopulationsSolid {...ownProps} />}
  </Icon>
);

Populations.displayName = 'Populations';

Populations.defaultProps = {
  outline: false,
};
