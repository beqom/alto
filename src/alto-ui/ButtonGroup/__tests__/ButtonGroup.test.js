...
describe('ButtonGroup', () => {
  ...
  it('is ButtonGroup', () => {
    const buttonGroup = shallow(<ButtonGroup onChange={() => {}} />);

    expect(buttonGroup).toBeTruthy();
  });
  it('has less then two items', () => {
    const buttonGroup = shallow(<ButtonGroup onChange={() => {}} items={[{ value: 1 }]} />);

    expect(buttonGroup.find('button')).toHaveLength(0);
  });
  it('has more then two items', () => {
    const items = [{ value: 1 }, { value: 2 }, { value: 3 }];
    const buttonGroup = shallow(<ButtonGroup onChange={() => {}} items={items} />);
  ...
  it('has additional class', () => {
    ...
    const buttonGroup = shallow(
      <ButtonGroup onChange={() => {}} items={items} className="test-class" />
    );
  ...
  it('has each button with small flag', () => {
    const items = [{ value: 1 }, { value: 2 }, { value: 3 }];
    const buttonGroup = shallow(<ButtonGroup onChange={() => {}} items={items} small />);
    const buttons = buttonGroup.find('button');
  ...
  it('has only second button as active on default', () => {
    ...
    const buttonGroup = shallow(<ButtonGroup onChange={() => {}} items={items} value="active" />);
  ...
  describe('Toggle tests', () => {
    describe('More than two buttons test case', () => {
      ...
      const items = [{ value: 1 }, { value: 2 }, { value: 3 }];
      const buttonGroup = shallow(<ButtonGroup onChange={onChange} items={items} value={2} />);
